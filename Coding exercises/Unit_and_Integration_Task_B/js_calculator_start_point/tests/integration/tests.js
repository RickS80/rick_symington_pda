...
// Do the arithmetical operations update the display with the result of the operation?
  ...
  it('should allow decimal number results', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should allow very large number results', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number9')).click();
    element(by.css('#number9')).click();
    element(by.css('#number9')).click();
    ...
    element(by.css('#number9')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('999999998000000000')
  })
  ...
  it('should return not a number if a number is divided by  decimal number results', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number9')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number2')).click();
